...
func main() {
	...
	wemPath := os.Args[1]
	bnkPath := "tmp/pak/OblivionRemastered/Content/WwiseAudio/Event/English(US)/Play_" + filepath.Base(wemPath) + ".bnk"
	...
	*/
	...
	outBnkPath := "german-voices-oblivion-remastered-voxmeld_v0.2.1_P/Content/WwiseAudio/Event/English(US)/" + filepath.Base(bnkPath)
	...
	outWemPath := "german-voices-oblivion-remastered-voxmeld_v0.2.1_P/Content/WwiseAudio/Media/English(US)/" + strconv.Itoa(int(id)) + ".wem"
